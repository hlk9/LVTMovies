...
namespace Movies.DAL.Context
{
    public class MovieDbContext:DbContext
    {
        ...
        {
            optionsBuilder.UseSqlServer("Data Source=LAPTOP-CXH2410\\SQLEXPRESS;Initial Catalog=LVTMovies;Integrated Security=True;Trusted_Connection=True;TrustServerCertificate=True;");
        }
